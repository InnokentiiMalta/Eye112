...
export default function BottomDock({ engine }: { engine: Engine }) {
  return (
    <div className="grid gap-3 md:grid-cols-[390px_minmax(0,1fr)]">
      {/* параметры конвейера */}
      ...
      <div className="panel flex min-h-0 flex-col p-3.5">
        ...
        <div className="min-h-[168px] flex-1 space-y-1 overflow-y-auto pr-1" style={{ maxHeight: 220 }}>
            ...
            return (
              ...
              >
                ...
                <span
                  ...
                  style={{ color: ev.severity === 'critical' ? '#f4483c' : ev.severity === 'alert' ? '#f0a35e' : '#c4cfdd' }}
                >
                  {ev.text}
                </span>
              </div>
